...
const Header = () => {
  ...
  return (
    <div className={`fixed top-0 left-0 w-full z-50 transition-shadow duration-300 ${isScrolled ? 'shadow-2xl rounded-b-[80px]' : ''}`}>
      <header className={`bg-background flex items-center justify-between max-w-[1202px] min-[1440px]:max-w-[1682px] mx-auto px-[10px] sm:px-[20px] md:px-[30px] min-[1202px]:px-0 transition-all duration-300 ${isScrolled ? 'md:py-2' : 'md:py-4'}`}>
