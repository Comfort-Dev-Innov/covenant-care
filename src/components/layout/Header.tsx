...
const Header = () => {
  ...
  return (
    <div ref={headerRef} className={`fixed bg-background top-0 left-0 w-full z-[9999] transition-shadow duration-300 ${isScrolled ? 'shadow-2xl rounded-b-[80px]' : ''} ${isInView ? 'animate-fadeIn' : 'opacity-0'}`}>
