...
export default function TeammateCard({ teammate }: { teammate: Teammate }) {
  return (
    <div className="font-inter flex flex-col items-center rounded-[18px] px-4 py-4 md:px-6 md:py-6 lg:px-[25px] lg:py-[40px] lg:w-[350px] lg:h-[380px] md:w-[250px] md:h-[280px] w-[200px] h-[230px] bg-[#2B3D4F] shadow-black/50 shadow-[0_0_10px_0_rgba(0.5,0.5,0.5,0.5)]">
      <Image
